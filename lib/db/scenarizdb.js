...
var nedbClient = module.exports = function (opts) {
	...
	this.cron = function () {this.dbcron(this.Scenarizdb, function (tbl_pl_list) {
								nedbobj.callback_play(tbl_pl_list,1,nedbobj,nedbobj.callback_play, function () {
									nedbobj.dbcron(nedbobj.ScenarizdbnoCron, function (tbl_pl_list) {
										nedbobj.callback_play(tbl_pl_list,1,nedbobj,nedbobj.callback_play, function() {
											nedbobj.removeNoCron(nedbobj.ScenarizdbnoCron,tbl_pl_list,0,nedbobj.removeNoCron);
										})
									})
								})}
							)};
...
nedbClient.prototype.removeNoCron = function (db, docs, pos, callback) {
