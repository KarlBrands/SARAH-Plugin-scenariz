...
var messages = {
	...
	askTosommaire: "Oui parfait ou oui s'il te plait. Suivant ou non merci. Inverse le sens. Quel est le sens. Terminé ou annule.",
	...
	stateAllCron: "Le programme %s est %d pour tous les clients. Il y a %a actions dans le programme. Début du programme à %h. Fin du programme à %z",
	prefixClients: ", le client",
	desactivatedCron: "désactivé",
	activatedCron: "activé",
	askWeekdaysCron: "quel jour à %s ?",
	askDaysSommaire: "Active. Désactive. Toute la Semaine ou semaine de travail. 'Le' suivi d'un jour de la semaine. Terminé, c'est bon ou annule.",
...
var error_messages = {
	...
	no_removeAll : "Il n'y a aucun prgramme à supprimer.",
}
